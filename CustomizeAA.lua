...
hk_dragger = dragging.new("Running BkT Flags Indicators", 400, 600)
hk_dragger_2 = dragging_2.new("Running BkT Boxer Indicators", 500, 600)
hk_dragger_3 = dragging_3.new("Running BkT Nememis Indicators", 500, 700)
hk_dragger_4 = dragging_4.new("Running BkT Fakelag Indicators", 100, 200)
hk_dragger_5 = dragging_5.new("Running BkT Safety Indicators", 1680, 35)
hk_dragger_6 = dragging_6.new("Running BkT LC Indicators", 1685, 55)
...
local enabled_custom_aa = ui.new_checkbox("AA", "Anti-aimbot angles", "★ Enabled BkT Customized AntiAim ★")
...
local function BkT_visible_enemy(ctx)
	...
	BkT_weapon_visible = visible and true or false
	stored_target = enemy_entindex
...
client.set_event_callback("paint", function(cmd)
	...
	local visible_peek = BkT_weapon_visible == nil and false or BkT_weapon_visible
	...
	local not_peek = can_fire_wall == false and BkT_weapon_visible == false
	local wall_peek = can_fire_wall == true and BkT_weapon_visible == false
...
local function command_fakelag(cmd)
	...
	BkT_real_global_choke = cmd.chokedcommands
	if BkT_real_global_choke <= First_CK then
		FL_0 = FL_1
		FL_1 = FL_2
		FL_2 = FL_3
		FL_3 = First_CK
	...
	First_CK = BkT_real_global_choke
end
...
local function draw_blackbox_indicator(x, y, w, h, a)
	...
	renderer.text(x + 124.5, y + 57.25, BkT_state_r, BkT_state_g, BkT_state_b, 255, "", 0, Status)
	...
	renderer.text(x_2 + 158, y_2 + 2, 128, 183, 255, 255, "", 0, "  BkT")    
	...
	renderer.text(x_4 + 158, y_4 + 2, 128, 183, 255, 255, "", 0, "  BkT")
	...
	renderer.gradient(max_val * 0.5 >= 10 and x_6 + lc_wind or x_6 + lc_wind, y_6 + 6, (max_val + BkT_real_global_choke / 2) / 2, 6, savor_slider_r, savor_slider_g, savor_slider_b, while_ariel and 0 or savor_slider_a, savor_slider_r, savor_slider_g, savor_slider_b, while_ariel and 0 or savor_slider_a, true)
...
client.set_event_callback("paint", function(Global_BkT_Hide_Menus_Short)
...
client.set_event_callback("paint", function(Global_BkT_Hide_Menus_Long)
