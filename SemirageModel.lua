ui.new_label("Rage","Other","----------Semirage----------")
...
local menu = {
    ...
    visuals = {
        enabled = ui.new_checkbox('VISUALS', 'Other ESP', 'Visual indicators for semirage'),
...
local function visibility_rage()
    ...
    ui.set_visible(menu.rage.penetration_hotkey, penetration and penetration_hotkey)
    ui.set_visible(menu.rage.penetreation_slider, penetration and penetration_visible)
    ui.set_visible(menu.rage.dynamicfov_min_snipers, dynamicfov and dynamicfov_mode == 'Snipers')
    ui.set_visible(menu.rage.dynamicfov_max_snipers, dynamicfov and dynamicfov_mode == 'Snipers')
    ui.set_visible(menu.rage.dynamicfov_min_deagle, dynamicfov and dynamicfov_mode == 'Deagle')
    ui.set_visible(menu.rage.dynamicfov_max_deagle, dynamicfov and dynamicfov_mode == 'Deagle')
    ui.set_visible(menu.rage.dynamicfov_min_pistols, dynamicfov and dynamicfov_mode == 'Pistols')
    ui.set_visible(menu.rage.dynamicfov_max_pistols, dynamicfov and dynamicfov_mode == 'Pistols')
    ui.set_visible(menu.rage.dynamicfov_min_others, dynamicfov and dynamicfov_mode == 'Others')
    ui.set_visible(menu.rage.dynamicfov_max_others, dynamicfov and dynamicfov_mode == 'Others')
end
...
local function rage()
    ...
    if semirage and improvements and improvements_hotkey and table_contains(ui.get(menu.rage.improvements_mode[1]), weapon) or fire and fire_hotkey then
        vars.rage.fire = true
    else
        vars.rage.fire = false
    end

    if penetration and penetration_hotkey then
