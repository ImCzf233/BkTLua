...
local enabled_check_box = ui.new_checkbox("LUA", "A", "Enabled BkT Advanced DoubleTap")
...
local indicator_types = ui.new_combobox("LUA", "A", "Double Tap Indicators Types", "Off", "BkT Presets", "Custom Text")
...
local function renderer_indicator(e)
	...
	ui.set_visible(dt_active_color, ui.get(enabled_check_box) and ui.get(indicator_types) == "BkT Presets" or ui.get(enabled_check_box) and ui.get(indicator_types) == "Custom Text")
	ui.set_visible(draw_circle, ui.get(enabled_check_box) and ui.get(indicator_types) == "BkT Presets" or ui.get(enabled_check_box) and ui.get(indicator_types) == "Custom Text")
	...
	local global_text = string.format("DT [%s] | Tickbase(v): %s", ui.get(indicator_types) == "BkT Presets" and "BkT Doubletap" or ui.get(custom_text), ui.get(fakeduck) and "Off" or cmove.last_charge >= 16 and "BkT" or cmove.last_charge)
